...
$('#prospectos-form').validate({
        rules: {
          ...
          apellidos: { minlength: 3, required: true },
          pagina: { minlength: 3, required: true },
          password: { minlength: 3, required: true },
          direccion: { minlength: 3, required: true },
          cp: { minlength: 3, required: true },
          pais: { required: true },
          estado: { required: true },
          ciudad: { required: true },
          correo: { minlength: 3, required: true },
          telefono: { minlength: 3, required: true }
        },
