...
<meta http-equiv="content-type" content="text/html;charset=UTF-8" />
    <meta charset="UTF-8" />
    <title>Atrévete a ser diferente - Lead Quest</title>
                    ...
                    <div class="span12">
                        ...
                        <div itemscope itemtype="http://schema.org/Product" id="product-221" class="post-221 product type-product status-publish has-post-thumbnail shipping-taxable purchasable product-type-simple product-cat-clothing product-cat-hoodies instock">
                                    ...
                                    <div class="slideshow_container flexslider with_thumbnails slide_layout_" id="contentflex">
                                        <ul class="slides slide_image_thumbnails">
                                            <li class=' slide_element slide1 frame1'>
                                                <img src='<?php echo base_url(); ?>assets/page/images/audio1.png' title='image1xxl (6)' alt='' />
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <div class="summary entry-summary">
                                ...
                                <h1 itemprop="name" class="product_title entry-title">Atrévete a ser diferente</h1>
                                <div class="price_rating">
                                    ...
                                    <div class="price_square">
                                        <div itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                                            ...
                                            <div class="price"><span class="amount">$15.00</span>
                                            </div>
                                ...
                                <div itemprop="description" class="desc_shop">
                                    <p>Esta conferencia sostiene que las únicas personas que serán recordadas en las próximas generaciones serán las que vivan para ser y marcar una diferencia. Debemos vivir de una forma tan intencional que dejemos una huella de impacto en las personas de nuestro entorno.</p>
                                </div>
                                ...
                                <form class="cart" method="post" action="<?php echo site_url("carrito"); ?>" >
                                    ...
                                    <input type="hidden" id="name" name="name" value="Atrévete a ser diferente">
                                    <input type="hidden" id="image" name="image" value="<?php echo base_url(); ?>assets/page/images/audio1.png">
