...
<body class="home page header_1_body fixed_slider with_slider_page wpb-js-composer vc_responsive">
    ...
    <div class="header_wrapper header_1 no-transparent ">
        <header id="header" class="">
           <?php $opcion = NULL; include("header.php"); ?>
        </header>
            ...
            <div class="container">
                 ...
                 <div class="breadcrumbss">
                    <ul class="page_parents pull-right">
                        ...
                        <li class="breadcrumbs_c"><a class="breadcrumbs_c" href="sobre-nosotros.php">Servicio a clientes</a></li>
                    </ul>
                 </div>
            </div>
        </div>
  ...
  <div class="container" id="page">
                <div class="row">
                    <div class="span3">
                        <ul class="side-nav">
                            <li><a href="reembolsos.php">Politicas de Reembolso</a>
                            </li>
                            ...
                            <ul>
                                ...
                                <li><a href="privacidad.php">Politicas de Privacidad</a>
                                </li>
                                <li><a href="pagos.php">Formas de Pago</a>
                                </li>
                                <li><a href="envios.php">Método de Envío</a>
                                </li>
                            </ul>
